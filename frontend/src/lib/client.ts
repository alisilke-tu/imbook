...
export namespace submissions {
    ...
    export class ServiceClient {
        ...
        public async List(): Promise<ListResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/submissions`)
        ...
        public async Submit(params: SubmitParams): Promise<void> {
            await this.baseClient.callTypedAPI("POST", `/submissions/submit`, JSON.stringify(params))
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "krcmar-v3-qie2-Generated-TS-Client (Encore/v1.53.8)";
        }
