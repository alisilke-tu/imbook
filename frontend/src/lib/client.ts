...
export function Environment(name: string): BaseURL {
    return `https://${name}-krcmar-v3-qie2.encr.app`
}
...
/**
 * Client is an API client for the krcmar-v3-qie2 Encore application.
 */
...
export namespace auth {
    ...
    export class ServiceClient {
        ...
        public async DeleteUser(uid: string): Promise<void> {
            await this.baseClient.callTypedAPI("DELETE", `/auth/users/${encodeURIComponent(uid)}`)
        }
        ...
        public async GetMe(): Promise<GetMeResponse> {
            ...
            return await resp.json() as GetMeResponse
        }
        ...
        public async ListUsers(): Promise<ListUsersResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/auth/users/list`)
         ...
         */
        public async ResetPassword(uid: string): Promise<ResetPasswordResponse> {
            // Now make the actual call to the API
...
export namespace chat {
    ...
    export class ServiceClient {
        ...
        public async Chat(params: ChatParams): Promise<ChatResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/chat`, JSON.stringify(params))
         ...
         */
        public async ChatStream(method: "POST", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/chat/stream`, body, options)
        }
    }
}
...
export namespace content {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.EmbedChunk = this.EmbedChunk.bind(this)
            this.Import = this.Import.bind(this)
            this.List = this.List.bind(this)
            this.ListChunks = this.ListChunks.bind(this)
        }
         ...
         */
        public async EmbedChunk(params: EmbedChunkParams): Promise<EmbedChunkResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/content/embed-chunk`, JSON.stringify(params))
            return await resp.json() as EmbedChunkResponse
        }
         ...
         */
        public async Import(method: "POST", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/content/import`, body, options)
        }
        ...
        public async List(): Promise<ListResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/content`)
         ...
         */
        public async ListChunks(): Promise<ListChunksResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/content/chunks`)
            return await resp.json() as ListChunksResponse
        }
    }
}
...
export namespace settings {
    ...
    export class ServiceClient {
         ...
         */
        public async Billing(): Promise<BillingResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/settings/billing`)
         ...
         */
        public async Set(params: SetParams): Promise<void> {
            await this.baseClient.callTypedAPI("POST", `/settings`, JSON.stringify(params))
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "krcmar-v3-qie2-Generated-TS-Client (Encore/v1.56.0)";
        }
