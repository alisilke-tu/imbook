-- Agent configurations (stores agent settings)
...
-- Chat sessions (track which config was used)
...
-- Execution traces (debugging and analytics)
CREATE TABLE execution_traces (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  session_id UUID NOT NULL REFERENCES chat_sessions(id) ON DELETE CASCADE,
  query TEXT NOT NULL,
  config_id UUID NOT NULL REFERENCES agent_configs(id),
  trace JSONB NOT NULL,       -- Step-by-step execution
  final_answer TEXT,
